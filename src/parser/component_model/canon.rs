...
use crate::component_model::{
    Binding, CanonOpt, ComponentFunction, CoreFunction, FuncValue, Idx, Resolvable,
};
...
pub fn parse_canon(
    ...
    match ctx.reader.read_exact_one()? {
        ...
        0x00 => {
            ...
            let ty = ctx.validator.resolve_idx(&ft)?;
...
fn parse_canon_opt(
    ...
    let opt = match ctx.reader.read_exact_one()? {
        ...
        0x03 => CanonOpt::Memory(parse_core_memory_idx(ctx)?),
        0x04 => CanonOpt::Realloc(parse_core_func_idx(ctx)?),
        0x05 => CanonOpt::PostReturn(parse_core_func_idx(ctx)?),
        #[cfg(feature = "component-gated-feature-async")]
        0x06 => CanonOpt::Async,
        #[cfg(feature = "component-gated-feature-async")]
