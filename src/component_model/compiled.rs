...
use crate::component_model::{ComponentFunction, CoreFunction, CoreGlobalRef, CoreInstance, CoreMemoryRef, CoreModule, CoreSort, CoreTableRef, CoreType, GlobalIdx, InlineComponent, Instance, InstanceIdx, Sort};
...
pub struct CompiledState {
    ...
    core_funcs: HashMap<GlobalIdx<CoreFunction>, Relation<CoreFunction>>,
    ...
    funcs: HashMap<GlobalIdx<ComponentFunction>, Relation<ComponentFunction>>,
}
...
impl CompiledState {
    ...
    pub fn register_core_instance(&mut self, idx: GlobalIdx<CoreInstance>, data: Relation<CoreInstance>) {
        self.core_instances.insert(idx, data);
    }
    
    pub fn register_core_func(&mut self, idx: GlobalIdx<CoreFunction>, data: Relation<CoreFunction>) {
    ...
    pub fn register_component(&mut self, idx: GlobalIdx<InlineComponent>, data: Relation<InlineComponent>) {
    ...
    pub fn register_func(&mut self, idx: GlobalIdx<ComponentFunction>, data: Relation<ComponentFunction>) {
