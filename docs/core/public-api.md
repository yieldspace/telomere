...
parses the root-re-exported Module definition in src/common.rs solely to record
the reviewed Module::codes field. It expands every explicit public use tree and
