...
) -> (telomere::Store, telomere::component::ComponentInstance) {
...
(component
  ...
  (core module $m
    ...
    (func (export "run") (param i32 f64 i32 i32) (result i32)
      (local $ret i32)
      (local.set $ret (call 0 (i32.const 0) (i32.const 0) (i32.const 4) (i32.const 20)))
      (i32.store (local.get $ret) (local.get 0))
      (f64.store (i32.add (local.get $ret) (i32.const 4)) (local.get 1))
      (i32.store (i32.add (local.get $ret) (i32.const 12)) (local.get 2))
      (i32.store (i32.add (local.get $ret) (i32.const 16)) (local.get 3))
      (local.get $ret)
    )
  )
...
(component
  ...
  (core module $m
    ...
    (func (export "run") (param i32 i64 i32) (result i32)
      ...
      (i32.store (local.get $ret) (local.get 0))
      (i64.store (i32.add (local.get $ret) (i32.const 4)) (local.get 1))
      (i32.store (i32.add (local.get $ret) (i32.const 12)) (local.get 2))
      (local.get $ret)
    )
  )
