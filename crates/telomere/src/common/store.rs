...
use super::{
    ...
    AsyncHostFunction, ControlFlowMetadataSite, Data, DerivedRuntimeMetadata, Elem, ExportSection,
    FrameLayoutHeader, FrameLayoutMetadata, FuncType, FuncTypeIdentity, GlobalType, HostFunction,
    Instr, LocalsData, MemType, ReturnShape, Stack, TableType, TypeIdx, VMResult,
};
...
pub(crate) use super::{
    PrecomputedBlockReturnSite, PrecomputedCallFrame, PrecomputedDirectCallSite,
