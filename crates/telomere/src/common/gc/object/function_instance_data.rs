use crate::common::{
    ...
    AsyncHostFunction, HostFunction, Instr, LocalsData,
};

const HOST_FUNC_MASK: u32 = 0x80000000;
const ASYNC_HOST_FUNC_MASK: u32 = 0x40000000;
...
impl FunctionInstanceData {
    ...
    pub fn is_async_host_func(&self) -> bool {
        self.function_flags & ASYNC_HOST_FUNC_MASK != 0
    }
    ...
    pub(crate) fn create_async_host_flags() -> u32 {
        HOST_FUNC_MASK | ASYNC_HOST_FUNC_MASK
    }
    ...
    pub fn async_host_code_pointer(&self, pool: &MemoryPool) -> AsyncHostFunction {
        unsafe { *pool.get_value::<AsyncHostFunction>(self.body, 0) }
    }
}
