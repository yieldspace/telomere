...
use crate::component::decoder::name::{is_kebab_label, parse_export_name};
...
fn assert_strict_instantiation_match(
    actual: &Type,
    expected: &Type,
    validator: &crate::component::decoder::Validator,
) -> ParseResult<()> {
    use crate::component::ir::types::{DefValType, GenericBound, ValType};
    ...
    fn compare_type_ids(
        ...
        expected: crate::component::ir::TypeId,
        validator: &crate::component::decoder::Validator,
    ) -> ParseResult<()> {
    ...
    fn compare_types(
        ...
        match (actual, expected) {
            (
                Type::Generic(crate::component::ir::types::Generic {
