...
jit_profile_counters! {
    ...
    CompileFrameCacheHit => "compile.frame_cache_hit",
    ...
    EmitBlockReturnNative => "emit.block_return.native",
    EmitBlockReturnNativeByte => "emit.block_return.native.byte",
    ...
    ExitContinuePtrConsumed => "exit.continue_ptr.consumed",
    ExitTrap => "exit.trap",
    ExitDone => "exit.done",
